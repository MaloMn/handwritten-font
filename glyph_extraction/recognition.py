...
subprocess.run(['wget', 'https://github.com/tulasiram58827/ocr_tflite/raw/main/data/represent_data.zip'])
subprocess.run(['unzip', 'represent_data.zip'])
...
image_path = 'glyph_extraction/tiles/70_2057.png'
